    ...
    <p>
        <a
            ...
            <span
                ...
                class="text-dev-500 material-icons-outlined absolute right-0 top-0 -mr-8 -mt-3 text-4xl">bolt</span>
            <span
                title=" {{ config('app.name', 'Laravel') }}"
                class="text-dev-500 material-icons-outlined absolute right-0 top-0 -mr-8 -mt-3 text-4xl animate-ping opacity-25">bolt</span>
        </a>
    </p>
    <p>
