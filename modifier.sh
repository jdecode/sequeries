...
PROJECT_REPO='sequeries'
PROJECT_API_SERVICE_NAME="sequeries-api"
PROJECT_PG_SERVICE_NAME="sequeries-pg"
PROJECT_TF_SERVICE_NAME="sequeries-tf"
PROJECT_IP_FIRST_TWO_OCTETS='221.230'
PROJECT_PORT_HTTP='1230'
PROJECT_PORT_VITE='1231'
PROJECT_PORT_DB='1232'
